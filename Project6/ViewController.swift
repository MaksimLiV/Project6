...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat:"V:|[label1(==80)]-[label2(==80)]-[label3(==88)]-[label4(==88)]-[label5(==88)]-(>=10)-|", options: [], metrics: nil, views: viewDictionary))
